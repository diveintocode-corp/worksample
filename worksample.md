...
あなたはプログラミングをやったことがないような初心者を対象に、最初中の最初のテキストを作成をします。この開発するテキストが終わった後にユーザーは、実際にRubyのコードを書いていくことになります。

従ってこのテキストでは、Pythonのコードを書き始める前に知っておくべきことについて紹介する必要があります。

【AI】  
Phase1カリキュラムにおけるPython基礎文法シリーズの最初のテキストを担当することになりました。

あなたはプログラミングをやったことがないような初心者を対象に、最初中の最初のテキストを作成をします。この開発するテキストが終わった後にユーザーは、実際にPythonのコードを書いていくことになります。
...
見出しを作成することができたら、その次はチームリーダーのレビューがあり、その後はその見出しに肉付けを行います。  
