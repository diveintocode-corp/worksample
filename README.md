...
さらにAIコースの志望の方には、現場で活躍するための最低限のスキルも確認しています。こちらもご確認ください。
...
以下のコンテストに取り組み、その結果を`5_kaggle.ipynb`、または`5_kaggle.py`に記述し、GithubにPushしてください。またフォルダを作成し、コードをモジュール化しても構いません。
...
- [ ] `5_kaggle.ipynb`、または`5_kaggle.py`に回答を記述した。（AIコース志望者のみ）
