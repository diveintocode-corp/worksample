...
教育メンターとして現場に配属されると、主に3つの業務を担当していただくことになります。  
それらと同じ内容を事前に体験して、 `本当にこの仕事と向き合えるかをご自分で確認する` ということが重要です。  
...
なお、教育メンターが担当するコースは、2つあります。「Webエンジニアコース」と「機械学習エンジニアコース」です。  
配属後は、これらのいずれかを担当していただくことになります。  
このワークサンプルでは、ご希望する分野に応じたいずれかのテーマに取り組んでください。  
...
【機械学習エンジニアコース】  
深層学習シリーズの`誤差逆伝搬法`のテキスト作成を担当することになりました。  
そこで、あなたはまず誤差逆伝播法の事前知識を生徒に学んでもらうことになりました。生徒のレベルは、Pythonを学び、その後、Pythonでアルゴリズム・データ構造を学んだ程度です。  
ここで重要なことは、誤差逆伝播法をきちんと理解するために必要な事前知識を調べて、見出しレベルで良いので落とし込むことです。  
初心者の人でも分かるようなテキストにすることを心がけて作成してください。  
